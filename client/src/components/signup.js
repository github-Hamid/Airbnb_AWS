...
function Signup() {
  ...
  function submitClicked(e) {
    ...
    if (fname.length < 3 || lname.length < 3) {
      ...
      li.innerText =
        "First name and Last name are required with at least 3 characters!";
      ul.appendChild(li);
    }
    ...
    if (
      password.length < 6 ||
      !checkPassword1.test(password) ||
      !checkPassword2.test(password) ||
      !checkPassword3.test(password) ||
      !checkPassword4.test(password)
    ) {
      let li = document.createElement("li");
      li.innerText =
        "password must be at least 6 characters with 1 lowercase, 1 uppercase, 1 digit and 1 special character";
      ul.appendChild(li);
    }
